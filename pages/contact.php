    ...
    <section class="py-16 md:py-20 text-white ">
        ...
        <div class="space-y-12">
            ...
            <div class="w-full h-64 md:h-80 lg:h-96 rounded-xl overflow-hidden border border-gray-700 BoxReveal">
                <iframe title="Max Gym Location Map" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3383.4675645537877!2d106.94713723293707!3d-6.919926571649072!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e684941017048b1%3A0x2a73ec0fa4f227cc!2sMax%20Gym%20%26%20Zumba%20Fitness%20performance!5e0!3m2!1sid!2sid!4v1772519316865!5m2!1sid!2sid" 
            ...
            <div id="contactForm" class="w-full bg-[#121212] p-6 md:p-10 rounded-2xl border border-white/5 BoxReveal">
                    ...
                    <form method="POST" autocomplete="off" class="space-y-4">
                        <div>
                            <label for="name" class="block text-sm font-medium mb-1"><?= $content['contact']['message']['input'][0]['title']?></label>
                            <input id="name" name="name" type="text" placeholder="<?= $content['contact']['message']['input'][0]['placeholder']?>"
                                class="w-full bg-[#121212] border border-gray-800 rounded-lg p-3 text-sm focus:border-purple-500 outline-none
                                 focus:placeholder-transparent">
                        </div>
                        <div>
                            <label for="email" class="block text-sm font-medium mb-1"><?= $content['contact']['message']['input'][1]['title']?></label>
                            <input id="email" name="email" type="email" placeholder="<?= $content['contact']['message']['input'][1]['placeholder']?>"
                                class="w-full bg-[#121212] border border-gray-800 rounded-lg p-3 text-sm focus:border-purple-500 outline-none
                                 focus:placeholder-transparent">
                        </div>
                        <div>
                            <label for="message" class="block text-sm font-medium mb-1"><?= $content['contact']['message']['input'][2]['title']?></label>
                            <textarea id="message" name="message" rows="4" placeholder="<?= $content['contact']['message']['input'][2]['placeholder']?>"
